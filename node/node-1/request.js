...
if (isNaN(reqCount) || reqCount < 1) {
  throw new Error('Первым аргументом необходимо передать количество запросов, число >= "1"');
}
...
if (reqType === 'a') {
  ...
  throw new Error('Вторым аргументом необходимо передать тип запросов: "a" - параллельный или "c" - последовательный');
}
